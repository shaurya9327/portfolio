    ...
    >
      <nav className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between font-mono text-sm">
        <a href="#top" className="text-accent font-bold flex items-center gap-2">
          <span className="inline-block w-2 h-2 rounded-full bg-green-400 shadow-[0_0_12px_2px_rgba(74,222,128,0.6)]" />
          ~/shaurya
        </a>
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden sm:inline-block border border-accent text-accent px-3 py-1.5 rounded hover:bg-accent hover:text-bg transition-colors"
          >
            resume.pdf
          </a>
          <button
          ...
          <ul className="max-w-6xl mx-auto px-6 py-4 flex flex-col gap-3 font-mono text-sm text-muted">
            {links.map((l) => (
              <li key={l.href}>
                <a
                  ...
                  className="block py-1 hover:text-fg"
                >
                  <span className="text-accent">$</span> {l.label}
                </a>
              </li>
            ...
            <li>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-block mt-2 border border-accent text-accent px-3 py-1.5 rounded"
              >
                resume.pdf
              </a>
            </li>
